...
export const GLOBAL_SHORTCUTS = [
  ...
  { group: '2D editing mode and snapping', rows: [['Box select', 'Left-drag on empty space'], ['Pan', 'Middle-drag / Space+Left-drag'], ['Zoom about the cursor', 'Wheel'], ['Skip snapping for this drag', 'Shift+drag'], ['Snap to half units', 'Ctrl+drag']] },

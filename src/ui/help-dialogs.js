...
export const GLOBAL_SHORTCUTS = [
  ...
  { group: '2D editing mode and snapping', rows: [['Box select', 'Left-drag on empty space'], ['Pan', 'Middle-drag / Space+Left-drag'], ['Zoom about the cursor', 'Wheel'], ['Snap on / off (grid, objects, ports, rotation, scale under View → Snap)', 'M'], ['Skip snapping for this drag', 'Shift+drag'], ['Snap to half the grid pitch', 'Ctrl+drag']] },
  { group: 'Edit in place (face fields)', rows: [['Edit the text under the pointer', 'Double-click'], ['Edit the selected block\'s first field', 'Enter'], ['Save · new line in a multiline field', 'Enter · Shift+Enter'], ['Cancel', 'Esc'], ['Next / previous field on the block', 'Tab / Shift+Tab'], ['Nudge a number', '↑ / ↓ (Shift: ×10)']] },
